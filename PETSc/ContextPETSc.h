...
#ifndef CONTEXTPETSC_H_TVT42RD2
#define CONTEXTPETSC_H_TVT42RD2
...
int ContextPETSc<N>::createAIJ_()
{
    ...
    // WIP: [fab4100@posteo.net; 2024-10-02] could use CSR structure identical
...
{
    const Matrix& A = this->getAMatrix();
    // WIP: [fab4100@posteo.net; 2024-10-02] see comment in createAIJ_
